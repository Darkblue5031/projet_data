...
for country, count in country_counts.items():
    try:
        ...
        # Ajuster la taille des marqueurs pour qu'elle soit proportionnelle au nombre de films
        ...
        # Ici, nous utilisons une colormap de type 'Reds' avec une inversion pour obtenir des couleurs plus claires pour les valeurs plus élevées
        color = plt.cm.Reds(count / country_counts.max())  # Division par le maximum pour normaliser entre 0 et 1

        m.scatter(x, y, s=marker_size, color=color, alpha=0.7, edgecolors='k', zorder=10)
    except IndexError:
        pass
